...
CREATE TABLE job (
  ...
  latitude_walk float DEFAULT NULL,
  longitude_walk float DEFAULT NULL,
  latitude_bike float DEFAULT NULL,
  longitude_bike float DEFAULT NULL,
  latitude_transit float DEFAULT NULL,
  longitude_transit float DEFAULT NULL,
  latitude_drive float DEFAULT NULL,
  longitude_drive float DEFAULT NULL,
  PRIMARY KEY (job_id),

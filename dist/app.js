...
function allow_cross_domain(req, res, next) {
  if (req.headers.origin || req.method == 'OPTIONS') {
    ...
    res.header("Access-Control-Allow-Headers", "Content-Type,Accept,X-Requested-With,X-HTTP-Method-Override,X-Yobs-API-Key,X-Yobs-User-Session-Key,X-Yobs-Admin-Session-Key");

...
function publish_live_job(req, res) {
  var job_details = req.body;
  console.log(job_details.industry_id);
  var sql = "INSERT INTO job (latitude_lower_walk, longitude_lower_walk, latitude_upper_walk, longitude_upper_walk, latitude_lower_bike, longitude_lower_bike, latitude_upper_bike, longitude_upper_bike, latitude_lower_metro, longitude_lower_metro, latitude_upper_metro, longitude_upper_metro, latitude_lower_car, longitude_lower_car, latitude_upper_car, longitude_upper_car, company_id, employer_id, is_deleted, job_role_id, job_type_id, job_schedule_id, title, location, description, responsibilities, activities, is_yobs_client, external_url, posted_at, deleted_at , industry_id ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
  var values = [34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, 34.0341, -118.222, job_details.company_id, 1, 0, job_details.job_role_id, 1, 1, job_details.job_title, job_details.job_loc, job_details.job_desc, job_details.job_desc, job_details.job_summ, 0, job_details.url, job_details.post_date.slice(0, 10), job_details.expiry_date.slice(0, 10), job_details.industry_id];
...
//# sourceMappingURL=live_job.js.map